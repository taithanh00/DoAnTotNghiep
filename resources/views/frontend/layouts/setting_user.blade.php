...
<body>
    <div class="mainDiv">
        <div class="cardStyle">
            <form action="{{ route('setting_user') }}" method="POST" name="signupForm" id="signupForm">
                @csrf
                <img src="https://cdn.pixabay.com/photo/2013/07/12/14/36/man-148582_640.png" id="signupLogo" />
