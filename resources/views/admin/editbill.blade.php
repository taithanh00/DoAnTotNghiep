...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Page/</span> Add Bill </h4>
        <div class="col-xxl">
            <div class="card mb-4">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <h5 class="mb-0">Add New Bill</h5>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" class="form-control" id="quantity_product" name="quantity_product"
                                        placeholder="Quantity Product" aria-label="John Doe"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    <span id="basic-icon-default-fullname2" class="input-group-text"><i
                                            class="bx bx-user"></i></span>
                                    <input type="text" class="form-control" id="total_final_product" name="total_final_product"
                                        placeholder="Total Final Product" aria-label="John Doe"
                                        aria-describedby="basic-icon-default-fullname2" />
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="date" class="form-control" id="date_bill_launch" name="date_bill_launch"
                                        placeholder="Date Bill Launch" aria-label="John Doe"
                                        aria-describedby="basic-icon-default-fullname2" />
                                </div>
                            </div>
                        </div>
